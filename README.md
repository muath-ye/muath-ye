...
| **D1** | [E2](https://github.com/muath-ye/muath-ye/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+E2), [F3](https://github.com/muath-ye/muath-ye/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+F3), [G4](https://github.com/muath-ye/muath-ye/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+G4), [H5](https://github.com/muath-ye/muath-ye/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+D1+to+H5) |
...
| Move | Author |
| :--: | :----- |
| `E7` to `E5` | [ @muath-ye](https://github.com/muath-ye) |
| `E2` to `E4` | [ @WatheqAlshowaiter](https://github.com/WatheqAlshowaiter) |
| `Start game` | [ @muath-ye](https://github.com/muath-ye) |
...
| Total moves |  User  |
| :---------: | :----- |
| 1 | [@WatheqAlshowaiter](https://github.com/WatheqAlshowaiter) |
| 1 | [@muath-ye](https://github.com/muath-ye) |
